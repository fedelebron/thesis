...
defineFlag "facets" "facets.ieq" ("Filename where facets will be " ++
                                  "found, as output by traf.")
defineFlag "vertex" "vertex.v" ("Filename where the fractional " ++
"vertex is found, where each line contains a variable and a value." ++
" Unmentioned variable are considered 0.")
