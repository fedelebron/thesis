...
\node[v] (d_i) at (12, 1) {$\beta_i$};
\node (d13) at (12, 0) {$\vdots$};
\node (d14) at (12, 2) {$\vdots$};
\node[v] (d15) at (12, 3) {$\beta_1$};
\node[v] (d16) at (12, -1) {$\beta_d$};
...
\draw[->] (d_ir_k) to node[above,blue] {$n'_{i, k}$} node[below,red] {$0$} (d_i);


\draw[e] ($(d_ir_k)!0.5cm!(d15)$) -> ($(d_ir_k)!1cm!(d15)$);
\draw[e] ($(d_ir_k)!0.5cm!(d16)$) -> ($(d_ir_k)!1cm!(d16)$);

\draw[e] ($(d11)!0.5cm!(d15)$) -> ($(d11)!1cm!(d15)$);
\draw[e] ($(d11)!0.5cm!(d16)$) -> ($(d11)!1cm!(d16)$);
\draw[e] ($(d12)!0.5cm!(d15)$) -> ($(d12)!1cm!(d15)$);
\draw[e] ($(d12)!0.5cm!(d16)$) -> ($(d12)!1cm!(d16)$);
\draw[e] ($(d11)!0.5cm!(d_i)$) -> ($(d11)!1cm!(d_i)$);
\draw[e] ($(d12)!0.5cm!(d_i)$) -> ($(d12)!1cm!(d_i)$);

\draw[->] (d_i) to node[above,blue] {$\infty$} node[below,red] {$0$} (t);
\draw[e] ($(d15)!0.5cm!(t)$) -> ($(d15)!1cm!(t)$);
\draw[e] ($(d16)!0.5cm!(t)$) -> ($(d16)!1cm!(t)$);
...
c(\beta_i \gamma_k, \beta_i) &= n'_{i, k}\ \forall\ i, k\\
c(\beta_i, t) &= \infty\ \forall\ i
\end{align*}
