\section{Multiple course, single start date, multiple weekly pattern}
...
\begin{tabular}{l||c|c}
  \hline
  $5$ & \cellcolor{Blue}$c_{1, 2}$ &\cellcolor{gray}$c_{4, 2}$ \\
  \hline
  $4$ & \cellcolor{gray}$c_{1, 2}$ & \cellcolor{Blue}$c_{4, 2}$\\
  \hline
  & 1 & 7
\end{tabular}
}
